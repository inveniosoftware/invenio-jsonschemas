...
extlinks = {
    'source': ('https://github.com/inveniosoftware/invenio-jsonschemas/tree/master/%s', 'source')
}
...
html_theme_options = {
    ...
    'extra_nav_links': {
        ...
        'invenio-jsonschemas@PyPI': 'https://pypi.python.org/pypi/invenio-jsonschemas/',
    }
}
...
texinfo_documents = [
    (master_doc, 'invenio-jsonschemas', u'Invenio-JSONSchemas Documentation',
     author, 'invenio-jsonschemas', 'Invenio module for building and serving JSONSchemas.',
     'Miscellaneous'),
]
